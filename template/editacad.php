...
<div class="tab-content">
    <div class="tab-pane active" id="about">
            <h3>Edit Academics</h3><br>
    <?php 
        $_SESSION['ID'] = $_GET['id'];
        $mysqli = connect();
        $idthis = $_GET['id'];
        $query = $mysqli->query("SELECT * FROM academics WHERE id=$idthis");
        while($result = $query->fetch_assoc()):
    ?>
        <form method="post" action="admin.php?action=academics&id=<?php echo $idthis; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="text" rows="3" name="text"><?= $result['content'] ?></textarea>
            </div>
            <div class="form-group">
   ...
   ?>
        ...
        <a href="admin.php?action=delete&id=<?php echo $idthis; ?>&link=academics">Delete</a>
    </div>
</div>
